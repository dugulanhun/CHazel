...
{
	m_SquareVA = CHazel::VertexArray::Create();
	...
	m_FlatColorShader = CHazel::Shader::Create("assets/shaders/FlatColor.glsl");
}
...
void Sandbox2D::OnUpdate(CHazel::Timestep ts)
{
	...
	CHazel::Renderer::Submit(m_FlatColorShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f)));
